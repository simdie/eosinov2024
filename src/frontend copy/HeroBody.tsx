  ...
  return (
    <div className=" bg-[#F5F7FF] flex flex-col justify-start mx-5 max-w-6xl sm:mx-auto my-12 sm:my-36">
      <div className="flex items-center justify-center w-full sm:w-3/4">
        <h5 className='space-x-3 hero-section'>
      ...
      <div className="text-left text-xl sm:text-2xl py-10 w-10/12">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-8">
        ...
        <div className=" text-gray-100 block md:hidden mb-6">
          ...
          <button onClick={() => handleLinkClick('https://eosi-finance.gitbook.io/eosi-finance-whitepaper/')} className="font-base bg-slate-300 py-5 px-16 rounded-lg text-amber-600 hover:translate-x-0.5 duration-700 hover:bg-gray-800 hover:text-white mb-6 sm:mb-0">
            Read the Whitepaper
          </button>
